...
export const getNewYorkBusinesses = () => {
    const filteredBusinesses = businesses.filter( isNewYorkBusiness )
...
export const getManufacturingBusinesses = () => {
    const filteredBusinesses = businesses.filter( isManufacturingBusiness )
    return filteredBusinesses
}


export const getPurchasingAgents = () => {
    const agentsArray = businesses.map(businessObject => {
        const agentObject = {
...
export const getSum = (businessObject) => {
  let sum = 0
  for (let i = 0; i < businessObject.orders.length; i++) {
    sum += businessObject.orders[i]
  }
  return sum
}
